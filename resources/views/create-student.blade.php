                            ...
                            <div class="card-body card-body">
                                ...
                                <form action="{{route('students.store')}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="company" name="name" placeholder="Enter your Name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="phone" name="phone" placeholder="+92123456789" class="form-control">
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="parent_contact" name="parent_contact" placeholder="+92123456789" class="form-control">
                                            </div>
                                        </div>
                                    </div>
